...

{
    ...
    public partial class FaceTrackingViewer : UserControl, IDisposable
    {
        ...
        public bool FaceBeingTracked { get; set; } 
                ...
                foreach (Skeleton skeleton in this.skeletonData)
                {
                        ...
                        || skeleton.TrackingState == SkeletonTrackingState.PositionOnly)
                    {
                        ...
                        if (this.trackedSkeletons.TryGetValue(skeleton.TrackingId, out skeletonFaceTracker))
                        {
                            ...
                            faceTop = skeletonFaceTracker.FaceRecTop()-40;
                            faceLeft = skeletonFaceTracker.FaceRecLeft()-20;
                            FaceBeingTracked = skeletonFaceTracker.FaceTracked;
                        }
                    }
                }
        ...
        private class SkeletonFaceTracker : IDisposable
        {
            ...
            private Microsoft.Kinect.Toolkit.FaceTracking.Rect faceRec;

            internal float FaceRecLeft()
            {
                return (float)(this.faceRec.Left);
                
            }

            internal float FaceRecTop()
            {
                return (float)(this.faceRec.Top);
            }
            ...
            public void DrawFaceModel(DrawingContext drawingContext)
            {
                ...
                // Hiding face triangles for demonstration
            ...
            public bool FaceTracked { get; set; }
        }
